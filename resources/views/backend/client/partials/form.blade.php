                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-center">
                            <input type="submit" name="clientSubmit" class="btn btn-primary waves-effect waves-light me-1">
                            <a class="btn btn-secondary waves-effect" href="{{ route('client.index') }}">
                                Back
                            </a>
                        </div>
                    </div>
...
<!-- init js -->
<script src="{{ asset('backend/assets/js/clients/form-editor.init.js') }}"></script>
