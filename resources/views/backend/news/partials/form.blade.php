                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            ...
                            @if(isset($news) && $news->image)
                                <input type="file" name="image" class="dropify" id="input-file-newss"
                        ...
                        <!--        <input type="file" name="banner_image" class="dropify" id="input-file-newss"-->
                        <!--               data-default-file="{{ asset($news->banner_path)}}"/>-->
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-center">
                            ...
                            <a class="btn btn-secondary waves-effect" href="{{ route('news.index') }}">
                                Back
                            </a>
                        </div>
                    </div>
